...
durante el proceso de ingeniera del CubeSat.
  ...
  \subsection{Criterios de Margenes}
    ...
    \subsubsection{Presupuesto Preliminar de Potencia}
      El presupuesto de potencia se cálculo considerando el caso mas desfavorable en cada uno
      de los componentes.
...
\section{Plan de Proyecto}
  ...
  normativos establecidos.
   ...
   \begin{table}[H]
     ...
     Baterías LI-PO 3,7V 3200mAh 90x40x4mm  & 6     & 8999   & 53994  \\
     ...
     \hline
     \multicolumn{3}{|r|}{\textbf{Total:}} & \textbf{330815} \\
     \hline
     \end{tabular}
     \caption{Costos}
     \label{tab:costos}
