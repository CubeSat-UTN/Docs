...
cálculo y simulación empleadas durante las etapas de diseño y verificación preliminar.
...
durante el proceso de ingeniera del CubeSat.
  ...
  \subsection{General}
    En la Figura \ref{fig:sistema_general} se presenta el diagrama en bloques del sistema general desarrollado para
  ...
  \subsection{Herramientas de Cálculo Empleadas}
    ...
    se emplearan herramientas de cálculo y software específicos que permitirán modelar los componentes
  ...
  \subsection{Criterios de Margenes}
    ...
    \subsubsection{Presupuesto Preliminar de Masa}
      ...
      \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|}
          ...
          Baterias 18650    & 5                                 & $46 \, g/u$           & $230 \, g$ \\ \hline
          Raspberry Pi Zero & 1                                 & $12.1 \,g/u$          & $12.1 \, g$ \\ \hline
          Celdas Peltier    & 3                                 & $24 \, g/u$           & $72 \, g$ \\ \hline
          Carcasas Subsust. & -                                 & $0,92 \, g/cm^3$      & $150 \, g$ \\ \hline
          \textbf{Total}    & -                                 & -                     & $628.46 \, g$ \\ \hline
        \end{tabular}
        \caption{Presupuesto de Pesos.}
      \end{table}

      Consideramos que con el margen de aproximadamente $370 \, g$ sobrantes, los componentes de cada subsistema
    ...
    \subsubsection{Presupuesto Preliminar de Potencia}
      El presupuesto de potencia se calculó considerando el caso mas desfavorable en cada uno
      de los componentes.
      ...
      \hline
      \textbf{Componente} & \textbf{Cant.} & \textbf{Tensión [V]} & \textbf{Corriente [A]} & \textbf{Potencia [W]} & \textbf{Subtotal [W]} & \textbf{@ 18V[A]} \\
      \hline
      Raspberry Pi Zero 2 W & 1 & 5.0  & 260 m & 260 m & 1.3 & 72.2 m   \\
      Atmega328p            & 1 & 5.0  & 5.2 m & 26 m & 26 m  & 1.4 m   \\
      Sensor BMP280         & 1 & 3.3  & 0.7 m & 2.3 m & 2.3 m & 0.12 m \\
      Sensor MPU9250        & 1 & 3.3  & 3.9 m & 12.9 m & 12.9 m & 0.71 m\\
      TB6612FNG             & 2 &  -   &   -   & 1 * canal & 3 & 166 m\\
      Celdas Peltier 4x4 cm & 3 & 12.0 & 833 m & 10.00  & 30.00  & 1.66   \\
      \hline
      \textbf{Total}        & – & –   & –      & –      & \textbf{34.34} & \textbf{1.9} \\
      \hline
      \end{tabular}
      }
      ...
      Para la mision elegimos tener 5 celdas 18650 de 3.6 V cada una con una capacidad de 3350 mAh y una capacidad
      maxima de descarga de 1.5C \cite{datasheet-cmicr18650-f9l}. Se dispondran todas en serie, teniendo un voltaje
      nominal de 18V a 3350mAh. Esto nos dará un tiempo de autonomia de 105 minutos. Esto es considerando casos mas
      desfavorables. Para el futuro, se buscara hacer ensayos reales del consumo de cada componente y se buscara que
      cada uno de ellos sea el menor posible.  Para determinar la potencia de los sensores se ha considerado sus
      respectivos datasheet \cite{datasheet-mpu9250} \cite{datasheet-bpm280}.
...
\section{Plan de Proyecto}
  ...
  normativos establecidos.
   ...
   \begin{table}[H]
     ...
     Plancha de aluminio 2mm 1000x1000mm (medio m2) & 0.06  & 74000  & 4625  \\
     Varillas acero inoxidable 5mm 1m               & 1     & 4900   & 4900   \\
     ...
     \hline
     \multicolumn{3}{|r|}{\textbf{Total:}} & \textbf{339836} \\
     \hline
     \end{tabular}
     \caption{Costos}
     \label{tab:costos}
